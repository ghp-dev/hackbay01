...
import { CapacityRed, CapacityGreen, CapacityYellow } from './capacity-state';
...
describe('VagCapacityService', () => {
  ...
  it('should return state green for line 65', () => {
    ...
    expect(result).toBe(CapacityGreen);
  });

  it('should return state red for line 44 direction Hbf at 8 am', () => {
    const result = service.getState('44', 'Nürnberg Hbf', new Date(2019, 5, 6, 8, 0, 0, 0));

    expect(result).toBe(CapacityRed);
  });

  it('should return state red for line 44 direction Hbf at 9 am', () => {
    const result = service.getState('44', 'Nürnberg Hbf', new Date(2019, 5, 6, 8, 0, 0, 0));
  ...
  it('should return state yellow for line U3 in both directions and all day long', () => {
    ...
    expect(result).toBe(CapacityYellow);
