...
import {WeatherServiceMock} from '../services/weather/weather-mock.service';
  ...
  triggerLeaveHomeToast() {
    ...
    ngOnInit() {
        ...
        if (!preferences.home || !preferences.work) {
          ...
          this.weatherService.fetchWeatherForecastHourly(this.travelDate)
            .subscribe(value => {
            this.weather = value;
            this.routingService
                .navigate( {
